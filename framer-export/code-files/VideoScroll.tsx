...
export function videoScrollProgress(Component): ComponentType {
  const SCROLL_START = 600; // Scroll position when animation starts
  const SCROLL_DISTANCE = 1200; // Scroll distance after which animation ends
  ...
  return (props) => {
    ...
    const progress = useTransform(scrollY, [SCROLL_START, SCROLL_END], [0, 1]);
